        ...
        <div class="text-center">
            ...
            <div class="mt-5 mb-5 p-3 border border-1 border-dark">
                ...
                <div class="text-start">
                    <p>It assumes you have a local database named <code>sample-db</code> served at <code>127.0.0.1:3306</code> and one table named <code>sample_table</code>.</p>
                    <p>You can change the configuration in <code>db-connect.php</code> and <code>index.php</code> files.</p>
                    <p>If you don't have a database locally, you can create it using the following MDB CLI command:</p>
                    <pre style="background-color: #c7c7c7; color: #343434;" class="py-1 ps-1"><code>$ mdb database init -db mysql8</code></pre>
